...
export default function MapaScreen() {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.statusContainer}>
          ...
          <Text style={styles.statusTextSmall}>
            Disponíveis: <Text style={[styles.statusNumberSmall, { color: Colors.success }]}> {statusCounts.disponível} </Text>
          </Text>
          <Text style={styles.statusTextSmall}>
            Manutenção: <Text style={[styles.statusNumberSmall, { color: Colors.warning }]}> {statusCounts.manutenção} </Text>
          </Text>
        </View>
      ...
      <WaitingArea motorcycles={motorcycles.filter(m => !m.position)} />
