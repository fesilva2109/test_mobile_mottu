...
const models: Motorcycle['model'][] = ['Mottu Pop','Mottu Sport','Mottu-E','Outro'];
const statuses: MotorcycleStatus[] = [ 'pronta','indisponivel','manutenção','reservada','transito'];
...
const RegistrationForm: React.FC<RegistrationFormProps> = ({
  ...
  const [model, setModel] = useState<Motorcycle['model']>('Mottu Pop');
  const [status, setStatus] = useState<MotorcycleStatus>('pronta');
