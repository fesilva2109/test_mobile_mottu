...
import { Mic, Check, X, MotorcycleKey, Camera as CameraIcon } from 'lucide-react-native';
import * as Speech from 'expo-speech';
import Colors from '@/constants/Colors';
import { useMotorcycles } from '@/contexts/MotorcycleContext';
import { Motorcycle, MotorcycleModel, MotorcycleStatus } from '@/types/motorcycle';
          ...
          <View style={styles.cameraContainer}>
            ...
            >
              ...
              <View style={styles.cameraControls}>
                ...
                >
                  <MotorcycleKey size={24} color={Colors.light.background} />
                </TouchableOpacity>
              </View>
            </CameraView>
          </View>
