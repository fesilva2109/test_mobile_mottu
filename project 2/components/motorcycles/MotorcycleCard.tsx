...
import { MotorcycleKey, MapPin, Calendar, AlertTriangle } from 'lucide-react-native';
...
const MotorcycleCard: React.FC<MotorcycleCardProps> = ({
  ...
  const getImageUrl = () => {
    switch (motorcycle.model) {
      ...
      case 'Off-road':
        return 'https://images.pexels.com/photos/2116475/pexels-photo-2116475.jpeg?auto=compress&cs=tinysrgb&w=600';
      default:
        ...
        <Card style={styles.compactCard}>
          ...
          <View style={styles.compactDetails}>
            <View style={styles.compactInfo}>
              <MotorcycleKey size={14} color={Colors.neutral[500]} />
        ...
        <View style={styles.content}>
          ...
          <View style={styles.details}>
            <View style={styles.detailRow}>
              <MotorcycleKey size={16} color={Colors.neutral[600]} />
