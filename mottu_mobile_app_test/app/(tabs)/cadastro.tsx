...
export default function CadastroScreen() {
  ...
  const [placa, setPlaca] = useState(params.placa as string || '');
  const [modelo, setModelo] = useState(params.modelo as string || MOTO_MODELS[0]);
  const [cor, setCor] = useState(params.cor as string || '');
  const [status, setStatus] = useState(params.status as string || MOTO_STATUSES[0]);
